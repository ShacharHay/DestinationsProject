...
namespace ApplicationsProject.Controllers
{
    public class ContinentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContinentId,Name")] Continent continent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContinentId,Name")] Continent continent)
        {
            if (ModelState.IsValid)
            {
